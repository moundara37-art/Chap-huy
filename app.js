...
async function downloadHistoryPdf(){
  ...
  sheet.style.position="fixed";sheet.style.left="-100000px";sheet.style.top="0";sheet.style.width="794px";sheet.style.background="#fff";sheet.style.padding="40px";sheet.style.zIndex="-1";
